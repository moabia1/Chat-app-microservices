...
import { ArrowUpRightSquare, ChevronLeft, Loader2, Lock } from "lucide-react";
      ...
      <div className="max-w-md w-full">
        <div className="bg-gray-800 border border-gray-700 rounded-lg p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <div className="flex justify-center in-checked: space-x-3">
                {otp.map((digit, index) => (
                  <input
                    className="w-12 h-12 text-center text-xl font-bold border-2 border-gray-600 rounded-2xl bg-gray-700 text-white"
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-400">Didn't recieve the code ?</p>
            {timer > 0 ? (
