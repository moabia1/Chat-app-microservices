  ...
  return (
    ...
    >
          ...
          <div className="space-y-4 h-full ">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 bg-gray-800 border border-gray-700 text-white rounded-full"
              />
            </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between mb-1">
                        ...
                        {unseenCount > 0 && (
                          <div className="bg-red-600 text-white text-xs rounded-full font-bold min-w-[22px] h-5.5 flex items-center justify-center px-2">
                            {unseenCount > 12 ? "12+" : unseenCount}
                          </div>
                        )}
                      </div>
                      {latestMessage && (
      ...
      <div className="p-4 border-t border-gray-700 space-y-2 ">
        <Link
          href={"/profile"}
          className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-gray-800 transition-colors cursor-pointer"
        >
